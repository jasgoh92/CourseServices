...
public class Main
{
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner ) {
        ...
        // the course grade
        //1) Get the Student Object / eg student 111 - studentservice object
        //2)
        //hasmap<string, enrolleccourse> getEnrolledCourse = studentService.getEnrolledCoruses();
        //For loop to loop through getEnrolledCourse and print out
        //3) allow user to enter the course code (find the enrolledCourse object)
        //4) allow user to enter the grade
        //5) studentservice.gradeStudent(student, course, grade)
            for(int i = 0; i < studentService.getEnrolledCourse(i); i++){
    ...
    private static void showPassedCourses(StudentService studentService, Scanner scanner )
    {
        ...
        for (int i = 0; i < enrolledCourses.size(); i++){
            return enrolledCourses.get(i).passedCourse
                    }
    }
}
